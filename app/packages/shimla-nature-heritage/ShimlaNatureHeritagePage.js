...
export default function ShimlaNatureHeritagePage() {
  ...
  const galleryImages = [
    { src: "/images/shimla.png", title: "The Ridge at Sunset", size: "md:col-span-2 md:row-span-1" },
    { src: "/images/manali.png", title: "Pine Forests of Kufri", size: "md:col-span-1 md:row-span-1" },
    { src: "/images/river.png", title: "Chadwick Falls Stream", size: "md:col-span-1 md:row-span-2" },
    { src: "/images/road-trip.png", title: "Himalayan Road Vistas", size: "md:col-span-2 md:row-span-1" },
    { src: "/images/camping.png", title: "Cozy Fireside Evenings", size: "md:col-span-1 md:row-span-1" },
    { src: "/images/kalpa.png", title: "Shali Tibba Viewpoint", size: "md:col-span-2 md:row-span-1" },
  ];
    ...
    <div className="bg-mountain-black text-foreground overflow-x-hidden min-h-screen">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Historic Shimla Ridge and heritage architecture at dusk"
          fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 glass rounded-xl p-4 border border-white/[0.08]">
                ...
                <p className="text-xs font-medium text-snow">Hotel Cedar Heights, Shimla</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 px-4 overflow-hidden border-t border-white/[0.02]">
        <Image
          ...
          alt="Sunset views of Himalayan ranges"
          fill
