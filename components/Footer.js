  ...
  return (
    <footer className="bg-mountain-black border-t border-white/[0.04]">
            ...
            <ul className="space-y-3">
              {footerLinks.expeditions.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-xs text-parchment-dim hover:text-snow link-underline transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
      ...
      <div className="border-t border-white/[0.03]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] text-stone-light/45 tracking-wider">
